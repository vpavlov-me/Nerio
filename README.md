...
the previous source and lock state and removes temporary artifacts. The lock records exact Registry
version, revision, file paths, dependency closure, original hashes, integrity metadata, and owners.
