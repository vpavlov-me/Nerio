export const motionClasses = {
  interactive:
    "transition-[background-color,border-color,color,opacity,scale,box-shadow,outline-color,text-decoration-color] duration-(--n-motion-hover-duration) ease-(--n-motion-hover-easing) [&:active:not(:disabled):not([data-disabled])]:duration-(--n-motion-press-duration) [&:active:not(:disabled):not([data-disabled])]:scale-(--n-motion-scale-subtle) focus-visible:duration-(--n-motion-focus-duration) focus-visible:ease-(--n-motion-focus-easing) motion-reduce:duration-(--n-duration-instant) motion-reduce:[&:active:not(:disabled):not([data-disabled])]:scale-100",
  control:
