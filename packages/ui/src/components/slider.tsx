...
const sliderControlClasses =
  "n-slider__control relative flex h-(--n-slider-control-size) w-full touch-none select-none items-center [--n-slider-control-layout-offset:calc((var(--n-slider-control-size)-var(--n-slider-track-size)-var(--n-slider-gap)-var(--n-slider-gap))*-0.5)] data-[orientation=vertical]:h-(--n-slider-length) data-[orientation=vertical]:w-(--n-slider-control-size) data-[orientation=vertical]:justify-center data-readonly:touch-auto";
      ...
      <BaseSlider.Control
        className={cn(
          ...
          orientation === "horizontal" && (label !== undefined || valueLabel !== undefined)
            ? "mt-(--n-slider-control-layout-offset)"
            : undefined,
          orientation === "horizontal" && description
            ? "mb-(--n-slider-control-layout-offset)"
            : undefined,
        )}
        data-readonly={readOnly ? "" : undefined}
        data-slot="control"
