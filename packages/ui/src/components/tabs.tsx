...
export const TabsTrigger = React.forwardRef<HTMLElement, TabsTriggerProps>(function TabsTrigger(
  ...
  return (
    <BaseTabs.Tab
      ...
      aria-labelledby={ariaLabelledBy}
      className={withClassName(className, tabsTriggerClasses)}
      data-slot="trigger"
    >
      {leadingIcon ? (
