...
const panelContentClasses =
  "n-accordion__panel-content box-border px-(--n-disclosure-panel-padding-inline) pb-(--n-disclosure-panel-padding-block) text-(length:--n-disclosure-panel-font-size) leading-(--n-disclosure-panel-line-height) text-(--n-disclosure-panel-foreground)";
