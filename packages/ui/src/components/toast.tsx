...
function ToastList({
  ...
  return manager.toasts.map((toast) => {
    ...
    return (
      ...
      >
        <BaseToast.Content
          className="n-toast__content flex flex-1 items-center gap-(--n-toast-content-gap) max-[30rem]:flex-wrap max-[30rem]:items-start"
          data-slot="content"
        >
          <ToastIndicator tone={tone} />
