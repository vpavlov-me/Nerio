...
const inputGroupClasses =
  "n-input-group flex min-h-(--n-input-height-md) w-full items-center overflow-hidden rounded-(--n-input-radius) border-(length:--n-input-border-width) border-(--n-input-border) bg-(--n-input-background) text-(--n-input-foreground) [&:hover:not(:focus-within):not(:has(.n-input:disabled)):not(:has(.n-input[data-readonly]))]:border-(--n-input-border-hover) [&:hover:not(:focus-within):not(:has(.n-input:disabled)):not(:has(.n-input[data-readonly]))]:bg-(--n-input-background-hover) focus-within:border-(--n-input-border-focus) data-invalid:border-(--n-input-border-danger) [&:has(.n-input[data-invalid])]:border-(--n-input-border-danger) data-invalid:focus-within:border-(--n-input-border-danger) [&:has(.n-input[data-invalid]):focus-within]:border-(--n-input-border-danger) [&:has(.n-input:disabled)]:cursor-not-allowed [&:has(.n-input:disabled)]:bg-(--n-input-disabled-background) [&:has(.n-input:disabled)]:text-(--n-input-disabled-foreground) [&:has(.n-input:disabled)]:opacity-(--n-input-disabled-opacity) [&:has(.n-input[data-readonly])]:border-(--n-input-readonly-border) [&:has(.n-input[data-readonly])]:bg-(--n-input-readonly-background) [&:has(.n-input[data-size=sm])]:min-h-(--n-input-height-sm) [&:has(.n-input[data-size=lg])]:min-h-(--n-input-height-lg) [&>.n-input]:min-w-0 [&>.n-input]:rounded-none [&>.n-input]:!border-0 [&>.n-input]:!bg-transparent [&>.n-input]:!shadow-none [&>.n-input:disabled]:opacity-100 forced-colors:border-[CanvasText]";
