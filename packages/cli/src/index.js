...
function help(commandName) {
  const sections = {
    ...
    root: [
      ...
      "",
      "Recommended local install: pnpm add -D @nerio-ui/registry@0.1.0-alpha.1 @nerio-ui/cli@0.1.0-alpha.1",
      "Run local commands with: pnpm exec nerio <command> [options]",
      "One-off example: pnpm dlx @nerio-ui/cli@0.1.0-alpha.1 init",
      "",
