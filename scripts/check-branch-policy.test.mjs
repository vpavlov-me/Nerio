...
test("keeps both required gates aligned with branch and DCO implementations", () => {
  const workflows = [
    readFileSync(resolve(root, ".github/workflows/pr-gate.yml"), "utf8"),
    readFileSync(resolve(root, ".github/workflows/release-gate.yml"), "utf8"),
  ];
