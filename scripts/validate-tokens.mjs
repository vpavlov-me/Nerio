...
function validate() {
  ...
  for (const [token, expected] of [
    ...
    ["--n-overlay-border-width", "var(--n-border-width-default)"],
    ["--n-overlay-border", "var(--n-color-border-subtle)"],
    ["--n-overlay-foreground", "var(--n-color-text-primary)"],
    ["--n-overlay-foreground-muted", "var(--n-color-text-secondary)"],
    ["--n-overlay-control-background", "var(--n-color-surface-control)"],
    ["--n-overlay-selected-background", "var(--n-color-surface-selected)"],
    ["--n-overlay-glass-background", "rgb(0 0 0 / 0.88)"],
    ["--n-overlay-glass-foreground", "var(--n-gray-0)"],
