...
The accepted Core 1.1 component set is additive and releases after stable 1.0. Forward development
may exist on `dev`, but the isolated `release/1.0` candidate excludes it; only focused stable
blocker fixes may be backported. SearchField remains #346 and NumberField is split into #370.
MultiSelect #349 is a
