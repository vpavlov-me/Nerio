...
- Made `nerio add` and `nerio update` operation-atomic: the CLI fetches and validates the complete
  ...
  lock state after injected source or lock failures. The CLI tarball grows from 10,559 to 15,197
  bytes and unpacked content from 40,917 to 62,215 bytes; reviewed budgets move from 12,000 to 16,000
  compressed bytes and from 50,000 to 65,000 unpacked bytes for this bounded transport and
