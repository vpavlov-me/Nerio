...
- Made `nerio add` and `nerio update` operation-atomic: the CLI fetches and validates the complete
  ...
  reuse. The CLI tarball grows from 10,559 to 18,715 bytes and unpacked content from 40,917 to
  79,145 bytes; reviewed budgets move from 18,000 to 19,000 compressed bytes and from 75,000 to
