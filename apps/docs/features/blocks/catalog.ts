...
export const blockCatalog = [
  ...
  },
  {
    ...
    description:
      "A bounded security card for credentials, two-factor protection, and active-session review.",
    category: "Settings and account",
    status: "Preview",
    previewRoute: "/views/blocks/security-settings",
    componentsUsed: ["Button", "Card", "Item"],
    intendedUse: "Adapt this block for account-level security controls.",
    boundaries: [
      "Authorization, reauthentication, audit history, and session revocation stay product-local.",
      "Sensitive confirmations and destructive account actions stay consumer-owned until a dedicated primitive is available.",
    ],
