...
function toStyle(
  ...
  return {
    ...
    "--n-toast-background": "var(--n-overlay-background)",
    "--n-toast-border": "var(--n-overlay-border)",
    "--n-toast-shadow": "var(--n-overlay-shadow)",
    "--n-toast-foreground": "var(--n-overlay-foreground)",
    "--n-toast-foreground-muted": "var(--n-overlay-foreground-muted)",
    "--n-toast-control-background": "var(--n-overlay-control-background)",
    "--n-toast-control-background-hover": "var(--n-overlay-control-background-hover)",
    "--n-toast-control-background-active": "var(--n-overlay-selected-background)",
    "--n-toast-status-color": "var(--n-color-text-secondary)",
    "--n-toast-status-info": "var(--n-color-status-info)",
    "--n-toast-status-success": "var(--n-color-status-success)",
    "--n-toast-status-warning": "var(--n-color-status-warning)",
    "--n-toast-status-danger": "var(--n-color-status-danger)",
