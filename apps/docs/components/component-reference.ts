  ...
  button: {
    ...
    api: [
      ...
      },
      {
        ...
        description:
          "Replaces the native button with an element or render function while preserving caller props, handlers, classes, content, state hooks, and refs. Set nativeButton to false for a native anchor.",
      },
    ],
    designNotes: [
