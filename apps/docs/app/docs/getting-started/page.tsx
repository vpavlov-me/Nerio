  ...
  return (
    <article className="doc-page">
      ...
      <section className="doc-section" id="install">
        <h2>Install</h2>
        <p>
          Nerio Core <code>1.0.0-beta.0</code> is the frozen candidate for the npm <code>beta</code>{" "}
          tag. It is not published yet. Install only the packages and peers used by your
          application; the stable 1.0 release is not published yet.
        </p>
