...
| `forms-labels-validation`       | `/visual-test`                 | Labels, errors, grouped controls, Select                   | Not run | Pending  |
...
| `calendar-grid`                 | `/docs/components/calendar`    | Grid navigation, constraints, locale, RTL                  | Not run | Pending  |
...
| `command-sidebar`               | `/visual-test`                 | Command active descendant, live states, Sidebar collapse   | Not run | Pending  |
