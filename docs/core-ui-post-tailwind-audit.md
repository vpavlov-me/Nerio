...
| Actions                        | Button icon/text modes and ButtonGroup; render/ref contracts and merge tests                          | **Follow-up required: #188.** The historical render-ref deviation remains resolved, but promotion review found a separate class-precedence regression in the custom render path. |
