...
| Component                                | API      | Visual and density | States                                              | Accessibility                                    | Tokens   | Docs and registry | Validation                       | Final status | Known issues                                                                                                  |
| ---------------------------------------- | -------- | ------------------ | --------------------------------------------------- | ------------------------------------------------ | -------- | ----------------- | -------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------- |
| Button                                   | Reviewed | Reviewed           | Loading, disabled, icon slots                       | Loading preserves the action name with aria-busy | Reviewed | Reviewed          | Contract and accessibility tests | stable-core  | `loadingLabel` is deprecated and has no accessible effect; remove it next major.                              |
| IconButton                               | Reviewed | Reviewed           | Loading now replaces icon with Spinner, disabled    | Loading preserves its label with aria-busy       | Reviewed | Reviewed          | Contract and accessibility tests | stable-core  | `loadingLabel` is deprecated; requires a label and Tooltip for unfamiliar actions.                            |
